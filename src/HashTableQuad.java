...
public class HashTableQuad {
	...
	public void insert(int n) {
		...
		for(int i = 0; i < tableSize; i++) {
			...
			// and we add i^2 because in the first case, i is always 0
			// so if it's not at the location, next increment, i will increase by the appropriate amount squared
			// AGAIN, GIVEN BY TA IN OFFICE HOURS
			ind = (int) ( ( (long)(n) + ((long)i)*(long)i )  % this.tableSize); // hash function again
